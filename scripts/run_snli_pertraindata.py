...
from transformers.data.processors import xnli_output_modes as output_modes
from utils_snli import xnli_compute_metrics as compute_metrics
...
def main():
    ...
    parser.add_argument("--per_train_data", default=100, type=int,
                        help="percentage of the train data to be used")
    ...
    if args.config_name == 'bert-base-cased':
